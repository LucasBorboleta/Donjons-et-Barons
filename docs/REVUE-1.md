...
En réaction aux retours du Jury 2026 du concours LudiNord, une revue s'impose sur TERRE-DE-BARONS.

Notamment :

- pour épurer le gameplay ;
- mieux exposer les règles ;
- mieux intégrer les règles dans le matériel du jeu.
...
- le **donjon** :
  ...
  - destruction
  - capture
- la **tuile de commandement** :
  - baron
  - donjon + chevalier
  - donjon
- les **officiers** :
  - baron : seul à construire
  - chevalier : pour la défense, et aussi pour le recrutement
- les **troupes** :
  - pour construire un donjon
  - pour attaquer un donjon
